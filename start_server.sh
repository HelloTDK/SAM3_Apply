...
echo "SAM3_CUDA_CLEANUP_AFTER_REQUEST=${SAM3_CUDA_CLEANUP_AFTER_REQUEST}"
echo "SAM3_IDLE_MODEL_UNLOAD_SECONDS=${SAM3_IDLE_MODEL_UNLOAD_SECONDS}"
echo "SAM3_CUDA_CLEANUP_LOG=${SAM3_CUDA_CLEANUP_LOG}"
